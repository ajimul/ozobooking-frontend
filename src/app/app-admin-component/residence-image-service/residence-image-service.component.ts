...
@Component({
  selector: 'app-residence-image-service',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, MatTableModule, MatDialogModule],
  templateUrl: './residence-image-service.component.html',
  styleUrl: './residence-image-service.component.css'
})
export class ResidenceImageServiceComponent {
