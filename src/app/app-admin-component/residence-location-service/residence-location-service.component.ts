...
@Component({
  selector: 'app-residence-location-service',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, MatTableModule, FormsModule, MatDialogModule],
  templateUrl: './residence-location-service.component.html',
  styleUrl: './residence-location-service.component.css'
})
export class ResidenceLocationServiceComponent {
  [x: string]: any;
  roomType: any;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<ResidenceLocationServiceComponent>,
