...
@Component({
  ...
  templateUrl: './client-login-component.component.html',
  styleUrl: './client-login-component.component.css'
})
export class ClientLoginComponentComponent implements OnInit {
  responsedata: any;
  loginform!: FormGroup;
  constructor(
    ...
    private fb: FormBuilder,private dialogRef: MatDialogRef<ClientLoginComponentComponent>
  ) {}
